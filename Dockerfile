...
RUN apt-get install -y php7.0-fpm php7.0-cli php7.0-mbstring php7.0-xml php7.0-curl php7.0-intl \
	php7.0-gd php7.0-sqlite3 curl git zip unzip rubygems sudo
